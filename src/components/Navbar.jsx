...
import { assets, menuLinks } from "../assets/assets"; // adjust path based on your folder structure
...
const Navbar = () => {
    ...
    const location = useLocation() // lets your Navbar know which page is currently active
        ...
        <div className={`flex items-center justify-between px-6 md:px-16 
            ...
            <div className={`max-sm:fixed max-sm:h-screen max-sm:w-full max-sm:top-16 
                ...
                <div className='hidden lg:flex items-center text-sm gap-2 border border-borderColor px-3 rounded-full max-w-56'>
                    <input type="text" className="py-1.5 w-full bg-transparent outline-none placeholder-grey-500" placeholder="Serch product:"/>
