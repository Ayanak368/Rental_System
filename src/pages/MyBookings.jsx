           ...
           rounded-lg mt-5 first:mt-12'>
            ...
            <div className='md:col-span-1'>
              <div className='rounded-md overflow-hidden mb-3'>
                <img src={booking.product.image} alt="" className='w-full h-auto aspect-video object-cover object-top' />
              </div>
              <p className='text-lg font-medium mt-2'>{booking.product.name}</p>
              <p className='text-gray-500'>{ booking.product.size}</p>
            </div>
            ...
            <div className='md:col-span-2'>
              <div className='flex items-center gap-2'>
                ...
                ${booking.status === 'confirmed' ? 'bg-green-400/15 text-gray-600' : 'bg-red-400/15 text-red-600'}`}>{booking.status}</p>
              </div>
