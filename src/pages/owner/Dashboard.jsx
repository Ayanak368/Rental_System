...
const Dashboard = () => {
  ...
  const dashboardCard = [
    { title: 'Total products', value: data.totalProducts, icon: assets.dress },
  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subtitle="Monitor overall platform performance including total products, bookings, revenue, and recent activities"
      />
          ...
          {data.recentBookings?.map((booking, index) => (
            <div key={index} className="mt-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p>
                    {booking.product?.name ?? ''} {booking.product?.category ?? ''}
                  </p>
