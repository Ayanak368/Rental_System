...
const Dashboard = () => {
    ...
    const dashboardCard = [
        {title: "Total products",value:data.totalProduct, icon:assets.carIconColored},
        {title: "Total Booking",value:data.totalBooking, icon:assets.listIconColored},
        {title: "Total Pending",value:data.pendingBooking, icon:assets.cautionIconColored},
        {title: "Total confirmed",value:data.completedBooking, icon:assets.listIconColored}
    ]
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
          <Title title="Admin Dashboard" subtitle="Moniter overall platform performance including total products,bookings,revenue,and recent activities" />
                  ...
                  {data.recentBooking.map((booking, index) => (
                      <div key={index} className='mt-4 flex items-center justify-between'>
                          <div className='flex items-center gap-2'> 
                              ...
                              <div>
                                  <p>{booking.product.name}{booking.product.category}</p>
